<?php 
    ...
    require('inc/paytm/endec_paytm.php.php');
    ...
    if(isset($_POST['pay_now']))
    {
        ...
        insert($query2,[$booking_id,$_SESSION['room']['id'],$_SESSION['room']['price'],$TXN_AMOUNT,$frm_data['name'],$frm_data['phonenum'],$frm_data['address']],'issssss');
