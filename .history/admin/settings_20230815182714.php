                    ...
                    <form>
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" onclick="site_title.value = general_data.site_title, site_title.value = general_data.site_title" class="btn text-secondary shadow-none" data-bs-dismiss="modal">CANCEL</button>
