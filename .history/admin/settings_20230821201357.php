           ...
           <div class="card border-0 shadow-sm mb-4">
            ...
            <div class="card border-0 shadow-sm mb-4">
                <div class="card-body">
                    ...
                    <p class="card-text">
                        No customers will be allowed to book hotels, when shutdown is turned on.
                    </p>
                </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <iframe id="iframe" class="border p-2 width-100" loading="lazy"></iframe>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-dialog">
                    <form id="team_s_form">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" onclick="te_title.value = general_data.site_title, site_about.value = general_data.site_about" class="btn text-secondary shadow-none" data-bs-dismiss="modal">CANCEL</button>
                                <button type="submit" onclick="upd_general(site_title.value,site_about.value)" class="btn custom-bg text-white shadow-none">SUBMIT</button>
                            </div>
                        </div>
                    </form>
...
<script>
    ...
    function upd_shutdown(val)
    {
        ...
        xhr.onload = function(){
            ...
            {
                alert('success','Site has been shutown!');
            }
            else{
