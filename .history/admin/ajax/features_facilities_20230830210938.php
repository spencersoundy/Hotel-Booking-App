...
if(isset($_POST['rem_feature']))
{
    ...
    $check_q = select('SELECT * FROM `room_feature` WHERE `features_id`=?',[$frm_data['rem_feature']],'i');
...
if(isset($_POST['rem_facility']))
{
    ...
    $check_q = select('SELECT * FROM `rooms_facilities` WHERE `facilities_id`=?',[$frm_data['rem_facilities']],'i');
