        ...
        $data.="
            <tr class='align-middle'>
              ...
              <td>
                ...
                <button type='button' onclick=\"remove_room_images($row[id], '$row[name]')\" class='btn btn-info shadow-none btn-sm' data-bs-toggle='modal' data-bs-target='#room-images'>
...
if(isset($_POST['thumb_image']))
{
    ...
    $pre_q = "UPDATE `room_images` SET `thumb`=? WHERE `sr_no`=? AND `room_id`=?";
