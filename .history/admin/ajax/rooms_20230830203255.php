...
if(isset($_POST['edit_room']))
{
    ...
    $q1 = "UPDATE `rooms` SET `name`='[value-2]',`area`='[value-3]',`price`='[value-4]',`quantity`='[value-5]',`adult`='[value-6]',`children`='[value-7]',`description`='[value-8]',`status`='[value-9]' WHERE 1";
}
