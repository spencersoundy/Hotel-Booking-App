...
if(isset($_POST['register']))
{
    ...
    $query = "INSERT INTO `user_ced`(`name`, `email`, `address`, `phonenum`, `pincode`, `dob`,
     `profile`, `password`,, `token`, `t_expired`, `status`, `datentime`) VALUES ('[value-1]','[value-2]','[value-3]','[value-4]','[value-5]','[value-6]','[value-7]','[value-8]','[value-9]','[value-10]','[value-11]','[value-12]','[value-13]','[value-14]')";
