                        ...
                        <form action="#" id="booking_form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <h6 class="mb-3 text-danger" id="pay_info">Provide check-in & check-out date!<h5>
            ...
            let xhr = new XMLHttpRequest();
                ...
                xhr.onload = function(){
                    ...
                    if(data.status == 'check_in_out_equal'){
                        ...
                        pay_info.innerText = "Check-in date is earlier then todays date!"
                    }
                    else if(data.status == 'unavailable'){
                        pay_info.innerText = "Room not available for this check-in date!"
                    }
                    else{
                        pay_info.innerHTML = "No. of Days: "+data.days+"<br>Total Amount to Pay: R"+data.payment;
                        pay_info.classList.replace('text-danger','text-danger');
