<div class="container-fluid bg-white mt-5">
    ...
    <script>
        ...
        register_form.addEventListener('submit', (e)=>{
            ...
            data.append('name',register_form.elements['pincode'].value);
            data.append('name',register_form.elements['dob'].value);
            data.append('name',register_form.elements['pass'].value);
            data.append('name',register_form.elements['cpass'].value);
        });
